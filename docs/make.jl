...
makedocs(;
  ...
  repo = "https://github.com/abelsiqueira/MyPkg.jl/blob/{commit}{path}#{line}",
  sitename = "MyPkg.jl",
  format = Documenter.HTML(;
    prettyurls = true,
    canonical = "https://abelsiqueira.github.io/MyPkg.jl",
...
deploydocs(; repo = "github.com/abelsiqueira/MyPkg.jl", push_preview = true)
